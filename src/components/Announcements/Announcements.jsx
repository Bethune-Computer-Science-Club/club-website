...
const Announcements = ({ redirectToAnnouncementsPage = true, maxShowAnnoucements = 1, ignoreMaxLimits = false }) => {
        ...
        (isLoaded) ?
          ...
          <div>
            <Container style={{ marginBottom: "50px" }}>
              <BigText redirectToAnnouncementsPage={redirectToAnnouncementsPage}>Announcements</BigText>
            </Container>
            {
            ...
            }
            {
              ...
              (announcements.length > 1 && !ignoreMaxLimits) ? redirect() : <></>
            }
          </div>
          :
          <>
